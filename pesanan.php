	...
	<form name="form1">
		<table width="48%" border="0" align="center">
			...
			if(isset($_POST['Pilih'])){
				echo "<h2>Berikut menu yang sudah dipilih : </h2>";
			if (isset($_POST['mkn1'])) {
				$m1 = $_POST['mkn1'];
				$j1 = $_POST['j1'];
				$tot1=$hrg['mkn1']*$j1;
		...
		echo "<tr><td>Total</td><td> </td><td>Rp.$tots</td>";
    	...
    	<table width="58%" border="0" align="center">
    		...
    		<form name="form1" method="post" action="struk.php">
    			<table width="58%" border="0" align="center">
					<tr>
						<td>Total</td>
						<td><input type="text" name="total" id="total" autocomplete="off"></td>
					</tr>
					<tr>
						<td>Bayar </td>
						<td><input name="bayar" type="text" id="bayar" autocomplete="off"></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
				...
				<br><a href=menu.php> Kembali</a></div>
</body>
</html>